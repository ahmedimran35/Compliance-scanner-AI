          ...
          <div className="flex flex-col justify-center items-center w-full p-16">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-lg leading-relaxed">
                Advanced AI-powered compliance scanning tool. 
            ...
            <div className="space-y-6 w-full max-w-md">
              {[
                { title: "AI-Powered", desc: "Advanced machine learning for accurate scans" },
                { title: "Enterprise Security", desc: "SOC 2 compliant with bank-level encryption" },
                { title: "50+ Standards", desc: "Global compliance frameworks supported" }
              ].map((benefit) => (
                <div
                  key={benefit.title}
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-gray-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/50 overflow-hidden">
              ...
              Get started today
                  ...
                  Create your account and start scanning in minutes
                  </p>
                </div>
          </div>
        ...
        {/* Footer */}
            ...
            >
              Sign in here
                ...
                <span className="text-xs text-gray-400 font-medium">Trusted by 10,000+ businesses</span>
                  </div>
                </div>
              </div>
            </div>
